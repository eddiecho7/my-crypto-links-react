...
const App = () => {
  ...
  const contractAddress = "0x0F8E8AA54D609174F0C92254FB27fB2862Ec694B";
  ...
  return (
    <div className="mainContainer">
      <div className="dataContainer">
        ...
        <div className="bio">
           I am Eddie and I am an aspiring blockchain developer. Connect your Ethereum wallet and wave at me!
        </div>

        <button className="waveButton" onClick={wave}>
          Wave at me with your message!
        </button>
